...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gpal-dev/GpalFwkUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gaurav Pal' => 'gpal-dev@github.com' }
  s.source           = { :git => 'https://github.com/gpal-dev/GpalFwkUtils.git', :tag => s.version.to_s }
